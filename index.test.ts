...
describe('detectMaliciousPrompt', () => {
  it('flags jailbreak attempts', () => {
    ...
    expect(result).toContain(FlaggedCategory.Jailbreak);
  });
  ...
  describe('evasion', () => {
    it('returns evasion for base64 injection', () => {
      ...
      expect(result).toContain(FlaggedCategory.Evasion);
    });
    ...
    it('does not return evasion when base64 check is disabled', () => {
      ...
      const result = detectMaliciousPrompt('Base64: SGVsbG8sIHdvcmxkIQ==');
      expect(result).not.toContain(FlaggedCategory.Evasion);
    });
  });
  ...
  describe('promptLeak', () => {
    it('returns promptLeak for reveal internal prompt', () => {
      ...
      expect(result).toContain(FlaggedCategory.PromptLeak);
    });
  ...
  describe('indirect', () => {
    it('returns indirect for URL injection', () => {
      ...
      expect(result).toContain(FlaggedCategory.Indirect);
    });
    ...
    it('does not return indirect when URL check is disabled', () => {
      ...
      expect(result).not.toContain(FlaggedCategory.Indirect);
  ...
  describe('roleContext', () => {
    it('returns jailbreak for system override', () => {
      ...
      expect(result).toContain(FlaggedCategory.RoleContext);
    });
